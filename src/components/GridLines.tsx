...
function GridLines() {
    return (
        <>
            ...
            {/* 풀 사이즈 수직선 */}
            <div className="v-line" style={{ left: 'var(--grid-line-x-1)' }}></div>
            <div className="v-line" style={{ left: 'var(--grid-line-x-3)' }}></div>
            <div className="v-line v-line-center" style={{ left: 'var(--grid-line-x-center)' }}></div>
